...
async function fetchData() {
  ...
  try {
    ...
    // const getcoin = await axios.post("http://localhost:5501/api/v2/getcoins", {
    ...
    const apipathGetprofiledetails = "/api/v2/getProfiledetails/"
    const fullUrlGetprofiledetails = `${baseUrl}${apipathGetprofiledetails}`
    // const response = await axios.get(
    //   "http://localhost:5501/api/v2/getProfiledetails/",
    //   {
    //     params: {
